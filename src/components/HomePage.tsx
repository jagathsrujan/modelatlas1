      ...
      <header className="border-b border-[var(--border)]">
        <div className="mx-auto max-w-6xl px-4 pb-10 pt-12 sm:px-6 sm:pb-14 sm:pt-16 lg:pt-20">
          <div className="grid items-center gap-10 lg:grid-cols-[1.02fr_1fr] lg:gap-14">
            <div className="rise">
              <h1 className="max-w-xl font-display text-[34px] leading-[1.04] tracking-[-0.02em] text-[#14181f] dark:text-white sm:text-5xl lg:text-[56px] text-balance">
                Choose the <em className="font-display italic">right AI</em> before you spend.
              </h1>
